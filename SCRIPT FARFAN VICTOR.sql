...
INSERT INTO EMPLEADO VALUES (1, SEC_PERSONA.CURRVAL, '3003001 Daisy Dr', '976351455', 'Futbol', NULL, '3-8-1997', '74130919', '224096', '22-10-2010', '1', '1', 'Observacion 1', 1, 'lawrence.cruz@gmail.com','1'); 

 

INSERT INTO PERSONA VALUES(2,SEC_PERSONA.NEXTVAL,1,'Trafic Clay','Clay	','Clay','Clay','1'); 

INSERT INTO EMPLEADO VALUES (2, SEC_PERSONA.CURRVAL, '595 Eason Rd', '907521493', 'Voley', NULL, '3-4-1998', '75500041', '224097', '22-10-1990', '1', '2', 'Observacion 2', 2, 'micheal.brown@gmail.com','1'); 

 

INSERT INTO PERSONA VALUES(3,SEC_PERSONA.NEXTVAL,1,'Lab Pelaez','LabP','LabP','LabP','1'); 

INSERT INTO EMPLEADO VALUES (3, SEC_PERSONA.CURRVAL, '8769 W Belt Line Rd', '905704997', 'Basquet', NULL, '2-4-1984', '78073872', '224098', '22-10-2020', '0', '3', 'Observacion 3', 3, 'candice.berry@gmail.com','1'); 
...
INSERT INTO PARTIDA VALUES(1,'I',SEC_PARTIDA_I.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Ingreso','1',1,'2','2',0,'1'); 

INSERT INTO PARTIDA VALUES(1,'I',SEC_PARTIDA_I.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Venta','1',1,'2','2',0,'1'); 

  

INSERT INTO PARTIDA VALUES(1,'E',SEC_PARTIDA_E.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Trafico','1',1,'1','1',0,'1'); 

INSERT INTO PARTIDA VALUES(1,'E',SEC_PARTIDA_E.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Topografía','1',1,'1','1',0,'1'); 

INSERT INTO PARTIDA VALUES(1,'E',SEC_PARTIDA_E.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Hidrología','1',1,'1','1',0,'1'); 

INSERT INTO PARTIDA VALUES(1,'E',SEC_PARTIDA_E.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Suelos','1',1,'1','1',0,'1'); 

INSERT INTO PARTIDA VALUES(1,'E',SEC_PARTIDA_E.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Puentes','1',1,'1','1',0,'1'); 

INSERT INTO PARTIDA VALUES(1,'E',SEC_PARTIDA_E.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Estructura 01','1',1,'1','1',0,'1'); 

INSERT INTO PARTIDA VALUES(1,'E',SEC_PARTIDA_E.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Especialista en Suelos','1',1,'1','1',0,'1'); 

INSERT INTO PARTIDA VALUES(1,'E',SEC_PARTIDA_E.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Asistente en Suelos','1',1,'1','1',0,'1'); 

INSERT INTO PARTIDA VALUES(1,'E',SEC_PARTIDA_E.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Obrero','1',1,'1','1',0,'1'); 

INSERT INTO PARTIDA VALUES(1,'E',SEC_PARTIDA_E.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'Laboratorio de Suelos','1',1,'1','1',0,'1'); 

INSERT INTO PARTIDA VALUES(1,'E',SEC_PARTIDA_E.NEXTVAL, 

 TO_CHAR(SEC_CODPARTIDAS.NEXTVAL,'99,999,999'),'FWD','1',1,'1','1',0,'1'); 

 

INSERT INTO PARTIDA_MEZCLA VALUES(1,'I',1,SEC_PARTIDA_MEZCLA_I.NEXTVAL, 

 0,'2','2',1000000,1,1,'1'); 

INSERT INTO PARTIDA_MEZCLA VALUES(1,'I',2,SEC_PARTIDA_MEZCLA_I.NEXTVAL, 

 1,'2','2',2000000,2,2,'1'); 

  

INSERT INTO PARTIDA_MEZCLA VALUES(1,'E',6,SEC_PARTIDA_MEZCLA_E.NEXTVAL, 

 0,'1','1',1000,1,1,'1'); 

INSERT INTO PARTIDA_MEZCLA VALUES(1,'E',1,SEC_PARTIDA_MEZCLA_E.NEXTVAL, 

 6,'1','1',2000,2,1,'1'); 

INSERT INTO PARTIDA_MEZCLA VALUES(1,'E',2,SEC_PARTIDA_MEZCLA_E.NEXTVAL, 

 6,'1','1',3000,2,2,'1'); 

INSERT INTO PARTIDA_MEZCLA VALUES(1,'E',3,SEC_PARTIDA_MEZCLA_E.NEXTVAL, 

 6,'1','1',4000,2,3,'1'); 

INSERT INTO PARTIDA_MEZCLA VALUES(1,'E',4,SEC_PARTIDA_MEZCLA_E.NEXTVAL, 

 6,'1','1',5000,2,4,'1'); 

INSERT INTO PARTIDA_MEZCLA VALUES(1,'E',5,SEC_PARTIDA_MEZCLA_E.NEXTVAL, 

 6,'1','1',6000,2,5,'1'); 

INSERT INTO PARTIDA_MEZCLA VALUES(1,'E',7,SEC_PARTIDA_MEZCLA_E.NEXTVAL, 

 4,'1','1',7000,3,1,'1'); 

INSERT INTO PARTIDA_MEZCLA VALUES(1,'E',8,SEC_PARTIDA_MEZCLA_E.NEXTVAL, 

 4,'1','1',8000,3,2,'1'); 

INSERT INTO PARTIDA_MEZCLA VALUES(1,'E',9,SEC_PARTIDA_MEZCLA_E.NEXTVAL, 

 4,'1','1',9000,3,3,'1'); 

INSERT INTO PARTIDA_MEZCLA VALUES(1,'E',10,SEC_PARTIDA_MEZCLA_E.NEXTVAL, 
...
INSERT INTO PROY_PARTIDA_MEZCLA VALUES(1,1,'I',1,2,SEC_PROY_PARTIDA_MEZCLA_I.nextval,1,'2','2',2,1,2000000,1,2000000);TA 
...
-- /** TABLAS NUEVAS **/
  ...
  CREATE TABLE "P_DPROY_PARTIDA_MEZCLA" 
   (	"CODCIA" NUMBER(6,0) NOT NULL ENABLE, 
	"CODPYTO" NUMBER(6,0) NOT NULL ENABLE, 
	"INGEGR" VARCHAR2(1 BYTE) NOT NULL ENABLE, 
	"NROVERSION" NUMBER(1,0) NOT NULL ENABLE, 
	"CODPARTIDA" NUMBER(6,0) NOT NULL ENABLE, 
	"CORR" NUMBER(6,0) NOT NULL ENABLE, 
	"SEC" NUMBER(4,0) NOT NULL ENABLE, 
	"TDESEMBOLSO" VARCHAR2(3 BYTE) NOT NULL ENABLE, 
	"EDESEMBOLSO" VARCHAR2(3 BYTE) NOT NULL ENABLE, 
	"NROPAGO" NUMBER(2,0) NOT NULL ENABLE, 
	"TCOMPPAGO" VARCHAR2(3 BYTE) NOT NULL ENABLE, 
	"ECOMPPAGO" VARCHAR2(3 BYTE) NOT NULL ENABLE, 
	"FECDESEMBOLSO" DATE NOT NULL ENABLE, 
	"IMPDESEMBNETO" NUMBER(9,2) NOT NULL ENABLE, 
	"IMPDESEMBIGV" NUMBER(8,2) NOT NULL ENABLE, 
	"IMPDESEMBTOT" NUMBER(9,2) NOT NULL ENABLE, 
	"SEMILLA" NUMBER(5,0) NOT NULL ENABLE, 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "P_PARTIDA_MEZCLA" 
   (	"CODCIA" NUMBER(6,0) NOT NULL ENABLE, 
	...
	"CODPARTIDA" NUMBER(6,0) NOT NULL ENABLE, 
	"CORR" NUMBER(6,0) NOT NULL ENABLE, 
	"PADCODPARTIDA" NUMBER(6,0) NOT NULL ENABLE, 
	"TUNIMED" VARCHAR2(3 BYTE) NOT NULL ENABLE, 
	"EUNIMED" VARCHAR2(3 BYTE) NOT NULL ENABLE, 
	"COSTOUNIT" NUMBER(9,2) NOT NULL ENABLE, 
	"NIVEL" NUMBER(5,0) NOT NULL ENABLE, 
	"ORDEN" NUMBER(5,0) NOT NULL ENABLE, 
	"VIGENTE" VARCHAR2(1 BYTE) NOT NULL ENABLE
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  CREATE TABLE "P_PARTIDAS" 
   (	"CODPARTIDA" NUMBER(6,0) NOT NULL ENABLE, 
	"INGEGR" VARCHAR2(6 BYTE) NOT NULL ENABLE, 
	"CODPARTIDAS" VARCHAR2(12 BYTE) NOT NULL ENABLE, 
	"DESPARTIDA" VARCHAR2(30 BYTE) NOT NULL ENABLE, 
	"NIVEL" NUMBER(2,0) NOT NULL ENABLE, 
	"VIGENTE" VARCHAR2(1 BYTE) NOT NULL ENABLE, 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "P_PROY_PARTIDA" 
   (	"CODCIA" NUMBER(6,0) NOT NULL ENABLE, 
	...
	"CODPARTIDA" NUMBER(6,0) NOT NULL ENABLE, 
	"CODPARTIDAS" VARCHAR2(12 BYTE) NOT NULL ENABLE, 
	"FLGCC" VARCHAR2(1 BYTE) NOT NULL ENABLE, 
	"NIVEL" NUMBER(2,0) NOT NULL ENABLE, 
	"UNIMED" VARCHAR2(5 BYTE) NOT NULL ENABLE, 
	"TABESTADO" VARCHAR2(3 BYTE) NOT NULL ENABLE, 
	"CODESTADO" VARCHAR2(3 BYTE) NOT NULL ENABLE, 
	"VIGENTE" VARCHAR2(1 BYTE) NOT NULL ENABLE, 
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE, 
	 CONSTRAINT "P_PROYECTO_PROY_PARTIDA_FK" FOREIGN KEY ("CODCIA", "CODPYTO")
	  REFERENCES "PROYECTO" ("CODCIA", "CODPYTO") ENABLE
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  CREATE TABLE "P_PROY_PARTIDA_MEZCLA" 
   (	"CODCIA" NUMBER(6,0) NOT NULL ENABLE, 
	...
	"ORDEN" NUMBER(5,0) NOT NULL ENABLE, 
	"COSTOUNIT" NUMBER(9,2) NOT NULL ENABLE, 
	"CANT" NUMBER(7,3) NOT NULL ENABLE, 
	"COSTOTOT" NUMBER(10,2) NOT NULL ENABLE, 
	 CONSTRAINT "P_PROY_PARTIDA_MEZCLA_PK" PRIMARY KEY ("CODCIA", "CODPYTO", "NROVERSION", "INGEGR", "CODPARTIDA", "CORR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)

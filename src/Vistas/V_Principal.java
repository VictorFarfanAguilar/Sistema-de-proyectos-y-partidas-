...
import Controlador.Plantilla;
import Controlador.Plantilla_Empleado;
...
public class V_Principal extends javax.swing.JFrame {
    private final FileNameExtensionFilter filter = new FileNameExtensionFilter("txt","pdf","pbix");
    ...
    public void init(){
        ...
        menu.addEventShowPopup(new EventShowPopupMenu() {
            ...
            public void showPopup(Component com){
                ...
                PopupMenu popup = new PopupMenu(V_Principal.this, item.getIndex(), item.getEventSelected(), item.getMenu().getSubMenu());
    ...
    private void initComponents() {
        ...
        jButton2.setText("Reporte Empleado");
        ...
        panelBackground1Layout.setHorizontalGroup(
            ...
            .addGroup(panelBackground1Layout.createSequentialGroup()
                .addGap(226, 226, 226)
                .addComponent(rSLabelFecha1, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panelBackground1Layout.setVerticalGroup(
            ...
            .addGroup(panelBackground1Layout.createSequentialGroup()
                .addGroup(panelBackground1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(rSLabelFecha1, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
...
if(opcion == JFileChooser.APPROVE_OPTION){
    String nombre = filechose.getSelectedFile().getName();
    //String ruta = filechose.getSelectedFile().getPath();
    try{
    File file = new File (filechose.getSelectedFile().getPath());
    
    if ( file.exists()){
        if(Desktop.isDesktopSupported()){
            Desktop.getDesktop().open(file);
        }else{
            JOptionPane.showMessageDialog(null, "no soporta");   
        }
    }
}
    catch (Exception e ){
...
// TODO add your handling code here:
    ...
    List<Cliente> lista = new ClienteDAO().listar();
        ...
        System.out.println("---");
Plantilla plan = new Plantilla (lista);
plan.crearPlantilla();
   ...
   System.out.println("PDF creado exitosamente.");
    ...
    public  void abrir(){
    try{
        File path = new File("reporte_gerencial_farfan_nuevo.pdf");
        Desktop.getDesktop().open(path);
    }catch(Exception ex){
        System.out.println("atencion");
    }
    }
    public static void crearPD() {
    List<Empleado> lista = new  EmpleadoDAO().listar();
        System.out.println("tamaño ");
        System.out.println(lista.size());
        System.out.println("---");
Plantilla_Empleado plan = new Plantilla_Empleado (lista);
plan.crearPlantilla();

   System.out.println("PDF creado exitosamente.");
}
      
    public  void abrirPDF_Empleado(){
    try{
        File path = new File("reporte_gerencial_farfan_nuevo.pdf");
        Desktop.getDesktop().open(path);
    }catch(Exception ex){
